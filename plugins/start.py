...
async def start(client,message):
	...
	**Document Or Video** and enter new filename to rename it__
	...
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Channel 🔦" ,url="https://t.me/animecolony") ], 
	[InlineKeyboardButton("Second Channel🔦", url="https://t.me/animedualaudiozippercartoonist") ]  ]))
	    return
	if id:
	    if old == True:
	        try:
	...
	**Document Or Video** and enter new filename to rename it__
	...
	[InlineKeyboardButton("Subscribe 🥰🕋", url="https://t.me/animecolony") ]  ]))
	        except:
	             return
	    else:
